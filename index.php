...
<body>
	...
	<div id="maincontent">
		...
		<div id="content">
			...
			<p><img src="img/maddoctor.jpg" class="doctorimg">The photo of a doctor on the right demonstrates the fact that we can Photoshop images, and happens to tie into the random statement we are making about 4 out of 5 doctors recommending young adults take up smoking to help stimulate the economy. It is also being advised that all people over the age of 60 begin smoking two packs a day. These two actions will help to generate revenue for the poor tobacco companies, and has the added benefit of alleviating the potential issue facing the Social Security Administration, as baby boomers begin draining the government honey pot.</p>
			...
			<p>Smoking cigarettes is a universal social normalizer. Any and all smoking areas belong to the community; you may often find a vagrant socializing with a millionaire within the confines of a "designated smoking area." They share lighters and discuss current affairs. Their individual backgrounds mean little when they huddle together during winter to stay warm. This open acceptance is the standard among all smokers. <img src="img/maddoctor.jpg" class="nurseimg"> All other cultures and groups should take a page from the smoker's handbook.Groups seeking acceptance need only take up smoking and walk to any smoking area to find a warm welcome to the community. The nerds of Lamda Lamda Lamda only needed to hit the local Minute Mart, pick up a pack of camels and a Bic lighter, and the Alpha Betas would have welcomed them into the smoking shack at Adams College with open arms.</p>
			
		<div id="footer">
			<p>&copy; DJD Productions, 2014</p>
		</div><!--end of footer-->
