...
<body>
	...
	<div id="maincontent">
		...
		<div id="content">
			...
			<p><img src="img/maddoctor.jpg" class="nurseimg">Smoking cigarettes is a universal social normalizer. Any and all smoking areas belong to the community; you may often find a vagrant socializing with a millionaire within the confines of a "designated smoking area." They share lighters and discuss current affairs. Their individual backgrounds mean little when they huddle together during winter to stay warm. This open acceptance is the standard among all smokers.  All other cultures and groups should take a page from the smoker's handbook.Groups seeking acceptance need only take up smoking and walk to any smoking area to find a warm welcome to the community. The nerds of Lamda Lamda Lamda only needed to hit the local Minute Mart, pick up a pack of camels and a Bic lighter, and the Alpha Betas would have welcomed them into the smoking shack at Adams College with open arms.</p>
